...
import (
	...
	endpoint "github.com/sanprasirt/gokit-sample/bugs/pkg/endpoint"
	http "github.com/sanprasirt/gokit-sample/bugs/pkg/http"
	service "github.com/sanprasirt/gokit-sample/bugs/pkg/service"
	"net"
	http1 "net/http"
	"os"
	"os/signal"
