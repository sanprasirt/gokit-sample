...
import (
	...
	endpoint "github.com/sanprasirt/gokit-sample/users/pkg/endpoint"
	http "github.com/sanprasirt/gokit-sample/users/pkg/http"
	service "github.com/sanprasirt/gokit-sample/users/pkg/service"
	"net"
	http1 "net/http"
	"os"
	"os/signal"
